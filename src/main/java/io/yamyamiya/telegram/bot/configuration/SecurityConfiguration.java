...
//                                .requestMatchers(HttpMethod.GET, "/message/id/*").permitAll()
//                                .requestMatchers(HttpMethod.POST, "/message").permitAll()
//                                .requestMatchers(HttpMethod.DELETE, "/message/delete/*").permitAll()
//                                .requestMatchers(HttpMethod.GET, "/message/chatId/*").permitAll()
//                                .requestMatchers(HttpMethod.GET, "/message/count").permitAll()
//                                .requestMatchers(HttpMethod.GET, "/message/count/chatId/*").permitAll()
//                                .requestMatchers(HttpMethod.GET, "/message/count/after/*").permitAll()
//                                .requestMatchers(HttpMethod.GET, "/message/count/before/*").permitAll()
//                                .requestMatchers(HttpMethod.GET, "/message/count/between/*/*").permitAll()
//
